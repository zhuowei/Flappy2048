    ...
    var Bird = Ω.Entity.extend({
        ...
        tick: function () {
            ...
            switch (this.state.get()) {
                case "BORN":
                    ...
                    this.mainframe.contentWindow.onkeydown = function(e) {
                        Ω.input.lastKey = e.keyCode;
                     };
        ...
        render: function (gfx) {
            ...
            window.game.atlas.render(
                ...
                this.x - 11,
                this.y - 17);
            /*var myframe = this.mainframe;
            myframe.style.left = this.x + "px";
            myframe.style.top = this.y + "px";*/
